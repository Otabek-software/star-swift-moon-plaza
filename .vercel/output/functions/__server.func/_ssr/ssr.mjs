...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-CuDJ2Q9o.mjs");
...
var manifest = {
	"1dc9a93218756009f6ceb645936b31c3443419f6b6fbf95b36009e9146b1ba06": {
		functionName: "analyzeSetup_createServerFn_handler",
		importer: () => import("./actions-nelV68Zg.mjs")
	},
	"30a5978685ff54ff9d6bdc5aa48e05595b832848bf4b41a079be18dda723fb2d": {
		functionName: "sendTelegramOrder_createServerFn_handler",
		importer: () => import("./actions-nelV68Zg.mjs")
	},
	"436302ff45d9d08db2077ef4b9b733ac5dc5d2a08dd3b8d814539c46f2c7df44": {
		functionName: "getGoldScan_createServerFn_handler",
		importer: () => import("./actions-nelV68Zg.mjs")
	}
};
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-BdRCuYjE.mjs").then((n) => n.t),
